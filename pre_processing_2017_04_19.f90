...
! 2017/04/11 ! cut the data to avoid the side problems due to bp filter
use sacio
!include 'fftw3.h'
implicit none
...
logical ext
real fre1(4),dt,fre2(4),t1
real sig(nmax,3),sigo(nmax,3),sigt(nmax)
real*8 dom
...
integer jday,npt2,icheck,n1
integer nerr,npts,iseg,nnpts
...
if (iargc().ne.1)then
   ...
   write(*,*)'dsec multpt com '
   write(*,*)'fa fb f1 f2 npts'
   write(*,*)'t1, npts'
   write(*,*)'data_dir'
   call exit(-1)
endif
...
read(10,*)dsec,multpt,co
read(10,*)fre1(2),fre1(3),fre2(2),fre2(3)
read(10,*)t1,nnpts
