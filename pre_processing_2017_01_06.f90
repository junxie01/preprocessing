   ...
   do id=begday,endday                ! loop over day
      ...
      do is=1,nst                     ! loop over station 
         do iseg=1,nseg               ! loop over segments
            ...
            call do_whiten(nn,dom,sachead(1),fre,sig,seisout)! frequency whitening
